...
TOP_WEB_PORTS = sorted({
    ...
    5900,5984,5985,5986,6080,6443,7001,7002,7071,7080,7180,7183,7443,7473,7474,
    ...
    8501,8530,8531,8834,8880,8881,8888,8889,8983,9000,9001,9002,9043,9060,9080,9090,
